...
public class Configuration {
  ...
  Map<String, String> naptanStopnames = null;
  ...
  /**
   * @return the naptanStopnames
   */
  public Map<String, String> getNaptanStopnames() {
    return naptanStopnames;
  }
  /**
   * @param naptanStopnames the naptanStopnames to set
   */
  public void setNaptanStopnames(Map<String, String> naptanStopnames) {
    this.naptanStopnames = naptanStopnames;
  }
  /**
